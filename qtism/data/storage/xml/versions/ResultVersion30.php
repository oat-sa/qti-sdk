...
{
    const XMLNS = 'http://www.imsglobal.org/xsd/imsqti_result_v3p0';

    const XSD = 'https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_resultv3p0_v1p0.xsd';

    const LOCAL_XSD = 'qtiv3p0/imsqti_resultv3p0_v1p0.xsd';
