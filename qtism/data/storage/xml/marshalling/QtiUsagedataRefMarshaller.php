...
use \DOMElement;
use qtism\data\QtiUsagedataRef;

/**
 * Marshalling/Unmarshalling implementation for QtiUsagedataRef.
 *
 * @author Aleksej Tikhanovich <aleksej@taotesting.com>
 *
 */
class QtiUsagedataRefMarshaller extends SectionPartMarshaller
{
    /**
     * Marshall an QtiUsagedataRef object into a DOMElement object.
     *
     * @param QtiComponent $component An QtiUsagedataRef object.
    ...
    protected function unmarshall(DOMElement $element)
    {
        ...
        if (($href = static::getDOMElementAttributeAs($element, 'href')) !== null) {
            $object = new QtiUsagedataRef($baseComponent->getIdentifier(), $href);
            return $object;
        } else {
