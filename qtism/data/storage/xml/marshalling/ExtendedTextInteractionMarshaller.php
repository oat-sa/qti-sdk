...
/**
 * Marshalling/Unmarshalling implementation for ExtendedTextInteraction.
 * 
 * @author Jérôme Bogaerts <jerome@taotesting.com>
 *
 */
class ExtendedTextInteractionMarshaller extends Marshaller {
	
	/**
	 * Marshall an ExtendedTextInteraction object into a DOMElement object.
	 * 
	 * @param QtiComponent $component An ExtendedTextInteraction object.
	 * @return DOMElement The according DOMElement object.
	 * @throws MarshallingException
	 */
	protected function marshall(QtiComponent $component) {
        $element = self::getDOMCradle()->createElement('extendedTextInteraction');
	...
	/**
	 * Unmarshall a DOMElement object corresponding to a extendedTextInteraction element.
	 * 
	 * @param DOMElement $element A DOMElement object.
	 * @return QtiComponent A ExtendedTextInteraction object.
	...
	protected function unmarshall(DOMElement $element) {
	    ...
	    if (($responseIdentifier = self::getDOMElementAttributeAs($element, 'responseIdentifier')) !== null) {
            ...
            try {
                $component = new ExtendedTextInteraction($responseIdentifier);
            }
            catch (InvalidArgumentException $e) {
                $msg = "The value '${responseIdentifier}' of the 'responseIdentifier' attribute of the 'extendedTextInteraction' element is not a valid identifier.";
            ...
            $msg = "The mandatory 'responseIdentifier' attribute is missing from the 'ExtendedTextInteraction' element.";
