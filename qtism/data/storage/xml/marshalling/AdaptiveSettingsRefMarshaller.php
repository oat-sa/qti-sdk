...
use qtism\data\AdaptiveSettingsRef;
use qtism\data\QtiComponent;
use \DOMElement;

/**
 * Marshalling/Unmarshalling implementation for adaptiveSettingsRef.
 *
 * @author Aleksej Tikhanovich <aleksej@taotesting.com>
 *
 */
class AdaptiveSettingsRefMarshaller extends SectionPartMarshaller
{
    /**
     * Marshall an AdaptiveSettingsRef object into a DOMElement object.
     *
     * @param QtiComponent $component An AdaptiveSettingsRef object.
    ...
    protected function unmarshall(DOMElement $element)
    {
        ...
        if (($href = static::getDOMElementAttributeAs($element, 'href')) !== null) {
            $object = new AdaptiveSettingsRef($baseComponent->getIdentifier(), $href);
            return $object;
        } else {
