...
class SelectableRouteCollection extends AbstractCollection {
	...
	/**
	 * Check if $value is a SelectableRoute object
	 * 
	 * @throws InvalidArgumentException If $value is a not a SelectableRoute object.
	 */
	 ...
	 * at position $key2.
	 *
	 * @param int $position1 A Step position.
	 * @param int $position2 A Step position.
