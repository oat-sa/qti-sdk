...
class XhtmlRenderingEngine extends AbstractMarkupRenderingEngine
{
    ...
    public function __construct()
    {
        ...
        $this->registerRenderer('audio', new AudioRenderer());
        ...
        $this->registerRenderer('source', new SourceRenderer());
        ...
        $this->registerRenderer('track', new TrackRenderer());
        $this->registerRenderer('uploadInteraction', new UploadInteractionRenderer());
        $this->registerRenderer('video', new VideoRenderer());
