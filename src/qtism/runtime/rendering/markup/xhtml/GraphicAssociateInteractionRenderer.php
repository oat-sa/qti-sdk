...
/**
 * GraphicAssociateInteraction renderer. Rendered components will be transformed as
 * 'div' elements with a 'qti-graphicAssociateInteraction' additional CSS class.
 *
...
class GraphicAssociateInteractionRenderer extends GraphicInteractionRenderer
{
    ...
    protected function appendAttributes(DOMDocumentFragment $fragment, QtiComponent $component, $base = '')
    {
        ...
        $this->additionalClass('qti-graphicAssociateInteraction');
    }
}
