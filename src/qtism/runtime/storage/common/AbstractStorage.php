...
abstract class AbstractStorage
{
     ...
     *
     * @param \qtism\data\AssessmentTest $test The test definition to be instantiated.
     ...
     * @throws \qtism\runtime\storage\common\StorageException If an error occurs while instantiating the AssessmentTest definition into an AssessmentTestSession object.
     */
     ...
     *
     * @param \qtism\data\AssessmentTest $test The test definition related to the AssessmentTestSession object to be retrieved.
    ...
    /**
     * Whether or not an AssessmentTestSession object exits in persistence.
     * 
     * This method allows you to know whether or not an AssessmentTestSession object
     * with a given $sessionId exists in the current storage.
     * 
     ...
     * 
     * This method enables you to delete an AssessmentTestSession object bound to
     * a given $sessionId from the storage.
     * 
     * If an AssessmentTestSession object is effectively bound to $sessionId in the
