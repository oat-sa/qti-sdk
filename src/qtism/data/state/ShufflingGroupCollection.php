...
/**
 * A collection of ShufflingGroup objects.
 */
class ShufflingGroupCollection extends QtiComponentCollection
{
    /**
     * Check if a given $value is an instance of ShufflingGroup.
     *
