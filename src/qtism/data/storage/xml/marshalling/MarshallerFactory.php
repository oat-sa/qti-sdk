...
use qtism\data\storage\xml\marshalling\OutcomeVariableMarshaller;
use qtism\data\storage\xml\marshalling\TemplateVariableMarshaller;
use qtism\data\storage\xml\marshalling\CandidateResponseMarshaller;
use qtism\data\storage\xml\marshalling\ResponseVariableMarshaller;
use qtism\data\storage\xml\marshalling\ItemResultMarshaller;
use qtism\data\storage\xml\marshalling\TestResultMarshaller;
use qtism\data\storage\xml\marshalling\SessionIdentifierMarshaller;
use qtism\data\storage\xml\marshalling\ContextMarshaller;
use qtism\data\storage\xml\marshalling\AssessmentResultMarshaller;
use qtism\data\storage\xml\marshalling\XIncludeMarshaller;
...
use qtism\data\storage\xml\marshalling\DlElementMarshaller;
use qtism\data\storage\xml\marshalling\ListMarshaller;
use qtism\data\storage\xml\marshalling\AtomicBlockMarshaller;
use qtism\data\storage\xml\marshalling\TableCellMarshaller;
use qtism\data\storage\xml\marshalling\TablePartMarshaller;
use qtism\data\storage\xml\marshalling\SimpleInlineMarshaller;
use qtism\data\storage\xml\marshalling\TemplateControlMarshaller;
use qtism\data\storage\xml\marshalling\ResponseControlMarshaller;
use qtism\data\storage\xml\marshalling\OutcomeControlMarshaller;
use qtism\data\storage\xml\marshalling\OperatorMarshaller;
use qtism\data\storage\xml\marshalling\NullValueMarshaller;
use qtism\data\storage\xml\marshalling\DefaultValMarshaller;
use qtism\data\storage\xml\marshalling\TemplateDeclarationMarshaller;
use qtism\data\storage\xml\marshalling\TextRunMarshaller;
use qtism\data\storage\xml\marshalling\WeightMarshaller;
use qtism\data\storage\xml\marshalling\VariableMarshaller;
use qtism\data\storage\xml\marshalling\VariableMappingMarshaller;
use qtism\data\storage\xml\marshalling\VariableDeclarationMarshaller;
use qtism\data\storage\xml\marshalling\UploadInteractionMarshaller;
use qtism\data\storage\xml\marshalling\TimeLimitsMarshaller;
use qtism\data\storage\xml\marshalling\TestVariablesMarshaller;
use qtism\data\storage\xml\marshalling\TestPartMarshaller;
use qtism\data\storage\xml\marshalling\TestFeedbackMarshaller;
use qtism\data\storage\xml\marshalling\TemplateProcessingMarshaller;
use qtism\data\storage\xml\marshalling\TemplateDefaultMarshaller;
use qtism\data\storage\xml\marshalling\SetTemplateValueMarshaller;
use qtism\data\storage\xml\marshalling\TemplateConstraintMarshaller;
use qtism\data\storage\xml\marshalling\TemplateConditionMarshaller;
use qtism\data\storage\xml\marshalling\DefaultValueMarshaller;
...
use qtism\data\storage\xml\marshalling\BaseValueMarshaller;
use qtism\data\storage\xml\marshalling\AssessmentSectionMarshaller;
use qtism\data\storage\xml\marshalling\ValueMarshaller;
use qtism\data\storage\xml\marshalling\SetCorrectResponseMarshaller;
use qtism\data\storage\xml\marshalling\AssessmentItemRefMarshaller;
use qtism\data\storage\xml\marshalling\SelectionMarshaller;
use qtism\data\storage\xml\marshalling\PreConditionMarshaller;
use qtism\data\storage\xml\marshalling\ExitTemplateMarshaller;
use qtism\data\storage\xml\marshalling\RandomIntegerMarshaller;
use qtism\data\storage\xml\marshalling\SetDefaultValueMarshaller;
use qtism\data\storage\xml\marshalling\DivMarshaller;
use qtism\data\storage\xml\marshalling\TableMarshaller;
use qtism\data\storage\xml\marshalling\SubstringMarshaller;
use qtism\data\storage\xml\marshalling\StylesheetMarshaller;
use qtism\data\storage\xml\marshalling\StringMatchMarshaller;
use qtism\data\storage\xml\marshalling\StatsOperatorMarshaller;
use qtism\data\storage\xml\marshalling\SliderInteractionMarshaller;
use qtism\data\storage\xml\marshalling\SimpleMatchSetMarshaller;
use qtism\data\storage\xml\marshalling\BranchRuleMarshaller;
use qtism\data\storage\xml\marshalling\TrMarshaller;
use qtism\data\storage\xml\marshalling\CaptionMarshaller;
use qtism\data\storage\xml\marshalling\SimpleAssociableChoiceMarshaller;
use qtism\data\storage\xml\marshalling\SetOutcomeValueMarshaller;
use qtism\data\storage\xml\marshalling\SelectPointInteractionMarshaller;
use qtism\data\storage\xml\marshalling\SectionPartMarshaller;
use qtism\data\storage\xml\marshalling\EqualMarshaller;
use qtism\data\storage\xml\marshalling\ColgroupMarshaller;
use qtism\data\storage\xml\marshalling\ColMarshaller;
use qtism\data\storage\xml\marshalling\ObjectMarshaller;
use qtism\data\storage\xml\marshalling\RubricBlockMarshaller;
use qtism\data\storage\xml\marshalling\RoundToMarshaller;
use qtism\data\storage\xml\marshalling\OutcomeDeclarationMarshaller;
use qtism\data\storage\xml\marshalling\ResponseDeclarationMarshaller;
use qtism\data\storage\xml\marshalling\ItemSessionControlMarshaller;
use qtism\data\storage\xml\marshalling\MatchTableMarshaller;
use qtism\data\storage\xml\marshalling\CorrectResponseMarshaller;
use qtism\data\storage\xml\marshalling\MappingMarshaller;
use qtism\data\storage\xml\marshalling\RepeatMarshaller;
use qtism\data\storage\xml\marshalling\RandomFloatMarshaller;
use qtism\data\storage\xml\marshalling\PositionObjectStageMarshaller;
use qtism\data\storage\xml\marshalling\PositionObjectInteractionMarshaller;
use qtism\data\storage\xml\marshalling\PatternMatchMarshaller;
use qtism\data\storage\xml\marshalling\OutcomeProcessingMarshaller;
use qtism\data\storage\xml\marshalling\OutcomeMinimumMarshaller;
use qtism\data\storage\xml\marshalling\OutcomeMaximumMarshaller;
use qtism\data\storage\xml\marshalling\OutcomeConditionMarshaller;
use qtism\data\storage\xml\marshalling\OrderingMarshaller;
use qtism\data\storage\xml\marshalling\MatchTableEntryMarshaller;
use qtism\data\storage\xml\marshalling\MapEntryMarshaller;
use qtism\data\storage\xml\marshalling\MathOperatorMarshaller;
use qtism\data\storage\xml\marshalling\LookupOutcomeValueMarshaller;
use qtism\data\storage\xml\marshalling\ParamMarshaller;
use qtism\data\storage\xml\marshalling\NumberSelectedMarshaller;
use qtism\data\storage\xml\marshalling\NumberRespondedMarshaller;
use qtism\data\storage\xml\marshalling\NumberPresentedMarshaller;
use qtism\data\storage\xml\marshalling\NumberIncorrectMarshaller;
use qtism\data\storage\xml\marshalling\NumberCorrectMarshaller;
use qtism\data\storage\xml\marshalling\ModalFeedbackMarshaller;
use qtism\data\storage\xml\marshalling\MediaInteractionMarshaller;
use qtism\data\storage\xml\marshalling\MathMarshaller;
use qtism\data\storage\xml\marshalling\MathConstantMarshaller;
use qtism\data\storage\xml\marshalling\MatchInteractionMarshaller;
use qtism\data\storage\xml\marshalling\MapResponsePointMarshaller;
use qtism\data\storage\xml\marshalling\MapResponseMarshaller;
use qtism\data\storage\xml\marshalling\LiMarshaller;
use qtism\data\storage\xml\marshalling\ItemSubsetMarshaller;
use qtism\data\storage\xml\marshalling\ItemBodyMarshaller;
use qtism\data\storage\xml\marshalling\InterpolationTableMarshaller;
use qtism\data\storage\xml\marshalling\InterpolationTableEntryMarshaller;
use qtism\data\storage\xml\marshalling\InsideMarshaller;
...
use qtism\data\storage\xml\marshalling\IndexMarshaller;
use qtism\data\storage\xml\marshalling\ImgMarshaller;
...
use qtism\data\storage\xml\marshalling\FieldValueMarshaller;
use qtism\data\storage\xml\marshalling\ExitTestMarshaller;
use qtism\data\storage\xml\marshalling\ExitResponseMarshaller;
use qtism\data\storage\xml\marshalling\EqualRoundedMarshaller;
...
use qtism\data\storage\xml\marshalling\DlMarshaller;
use qtism\data\storage\xml\marshalling\CorrectMarshaller;
use qtism\data\storage\xml\marshalling\BlockquoteMarshaller;
use qtism\data\storage\xml\marshalling\AssociateInteractionMarshaller;
use qtism\data\storage\xml\marshalling\AssessmentTestMarshaller;
use qtism\data\storage\xml\marshalling\AssessmentSectionRefMarshaller;
use qtism\data\storage\xml\marshalling\AssessmentItemMarshaller;
use qtism\data\storage\xml\marshalling\AreaMappingMarshaller;
use qtism\data\storage\xml\marshalling\AreaMapEntryMarshaller;
use qtism\data\storage\xml\marshalling\AnyNMarshaller;
use qtism\data\storage\xml\marshalling\ResponseProcessingMarshaller;
use qtism\data\storage\xml\marshalling\ResponseConditionMarshaller;
use qtism\data\storage\xml\marshalling\HrMarshaller;
use qtism\data\storage\xml\marshalling\BrMarshaller;
