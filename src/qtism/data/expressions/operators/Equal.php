...
class Equal extends Operator
{
     ...
     */
    public function __construct(ExpressionCollection $expressions, $toleranceMode = ToleranceMode::EXACT, $tolerance = [], $includeLowerBound = true, $includeUpperBound = true)
    {
