...
class GraphicOrderInteractionMarshallerTest extends QtiSmTestCase {
	...
	public function testMarshall() {
	    ...
	    $choice1 = new HotspotChoice('choice1', Shape::CIRCLE, new QtiCoords(Shape::CIRCLE, array(0, 0, 15)));
	    $choice2 = new HotspotChoice('choice2', Shape::CIRCLE, new QtiCoords(Shape::CIRCLE, array(2, 2, 15)));
	    $choice3 = new HotspotChoice('choice3', Shape::CIRCLE, new QtiCoords(Shape::CIRCLE, array(4, 4, 15)));
