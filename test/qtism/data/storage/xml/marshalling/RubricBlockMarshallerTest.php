...
class RubricBlockMarshallerTest extends QtiSmTestCase {
	...
	public function testUnmarshall() {
        ...
        $this->assertEquals(2, count($rubricBlockContent));
        $this->assertInstanceOf('qtism\\data\\content\\xhtml\\text\\H3', $rubricBlockContent[0]);
        $this->assertInstanceOf('qtism\\data\\content\\xhtml\\text\\P', $rubricBlockContent[1]);
	...
	public function testMarshall() {
	    ...
	    $rubricBlock->setContent(new BlockCollection(array($h3, $p)));
	    ...
	    $this->assertEquals('<rubricBlock view="candidate tutor"><stylesheet href="./stylesheet.css" media="screen" type="text/css"/><h3>Be carefull kiddo!</h3><p>Read the instructions twice.</p></rubricBlock>', $dom->saveXML($element));
	}
}