...
class FeedbackInlineMarshallerTest extends QtiSmTestCase {
	...
	public function testMarshall() {
	    ...
	    $feedback = new FeedbackInline('outcome1', 'please_show_me', ShowHide::HIDE, 'my-feedback', 'super feedback');
	    ...
	    $this->assertEquals('<feedbackInline id="my-feedback" class="super feedback" outcomeIdentifier="outcome1" identifier="please_show_me" showHide="hide">This is text...</feedbackInline>', $dom->saveXML($element));
	}
	
	public function testUnmarshall() {
	    $element = $this->createDOMElement('
	        <feedbackInline id="my-feedback" class="super feedback" outcomeIdentifier="outcome1" identifier="please_show_me" showHide="hide">This is text...</feedbackInline>
	    ');
