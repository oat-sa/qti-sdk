...
class PhpMarshallingContextTest extends QtiSmTestCase {
    ...
    public function testGenerateVariableName() {
        ...
        $this->assertEquals('coords_0', $ctx->generateVariableName(new QtiCoords(QtiShape::CIRCLE, array(10, 10, 5))));
        $this->assertEquals('coords_1', $ctx->generateVariableName(new QtiCoords(QtiShape::CIRCLE, array(10, 10, 3))));
        ...
        $this->assertEquals('coords_2', $ctx->generateVariableName(new QtiCoords(QtiShape::CIRCLE, array(5, 5, 3))));
    }
}
