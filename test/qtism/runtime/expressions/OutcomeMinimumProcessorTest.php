...
class OutcomeMinimumProcessorTest extends QtiSmItemSubsetTestCase {
	...
	public function outcomeMinimumProvider() {
	    return array(
	        array(self::getOutcomeMinimum('SCORE'), new MultipleContainer(BaseType::FLOAT, array(-2.0, 0.5, 1.0, 1.0, 1.0, 1.0))),
	        array(self::getOutcomeMinimum('SCORE', '', '', new IdentifierCollection(array('minimum'))), new MultipleContainer(BaseType::FLOAT, array(-2.0, 0.5, 1.0, 1.0, 1.0, 1.0))),
	        array(self::getOutcomeMinimum('SCORE', 'W01', '', new IdentifierCollection(array('minimum'))), new MultipleContainer(BaseType::FLOAT, array(-4.0, 1.0, 2.0, 2.0, 2.0, 2.0))),
	        array(self::getOutcomeMinimum('SCORE', 'W01', '', new IdentifierCollection(array('minimum', 'maximum'))), new MultipleContainer(BaseType::FLOAT, array(-4.0, 1.0, 2.0, 2.0, 2.0, 2.0))),
	        array(self::getOutcomeMinimum('SCORE', 'W01'), new MultipleContainer(BaseType::FLOAT, array(-4.0, 1.0, 2.0, 2.0, 2.0, 2.0))),
	        array(self::getOutcomeMinimum('SCORE', 'W02', '', new IdentifierCollection(array('minimum'))), new MultipleContainer(BaseType::FLOAT, array(-2.0, 0.5, 1.0, 1.0, 1.0, 1.0))), // Weight not found
	    );
	}
