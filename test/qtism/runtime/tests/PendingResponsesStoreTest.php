...
class PendingResponseStoreTest extends QtiSmTestCase {
    ...
    public function testPendingResponseStore() {
        ...
        $state1 = new State(array(new ResponseVariable('RESPONSE', Cardinality::SINGLE, BaseType::BOOLEAN, true)));
        $state2 = new State(array(new ResponseVariable('RESPONSE', Cardinality::SINGLE, BaseType::BOOLEAN, false)));
        $state3 = new State(array(new ResponseVariable('RESPONSE', Cardinality::SINGLE, BaseType::INTEGER, 1337)));
