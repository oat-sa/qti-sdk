...
class TemporaryQtiBinaryStorageTest extends QtiSmTestCase {
    ...
    public function testNonLinearNavigation() {
        ...
        $this->assertTrue($session['nonlinear5items.duration']->equals(new Duration('PT0S')));
        ...
        $this->assertTrue($session['Q01.duration']->equals(new Duration('PT3S')));
        ...
        $this->assertTrue($session['Q03.duration']->equals(new Duration('PT3S')));
        ...
        // MOVE_BACK Q02 -> Q01.
        $session->moveBack();
        $this->assertTrue($session['nonlinear5items.duration']->equals(new Duration('PT10S')));
        $this->assertTrue($session['P01.duration']->equals(new Duration('PT10S')));
        $this->assertTrue($session['S01.duration']->equals(new Duration('PT10S')));
        $this->assertTrue($session['Q02.duration']->equals(new Duration('PT4S')));
