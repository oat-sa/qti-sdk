...
$end = microtime();
echo "Retrieving session + attempt 36 + persistance (" . spentTime($start, $end) . ")\n";
...
$end = microtime();
echo "Retrieving session + attempt 37 + persistance (" . spentTime($start, $end) . ")\n";
...
$end = microtime();
echo "Retrieving session + attempt 38 + persistance (" . spentTime($start, $end) . ")\n";
...
$end = microtime();
echo "Retrieving session + attempt 39 + persistance (" . spentTime($start, $end) . ")\n";
...
$end = microtime();
echo "Retrieving session + attempt 40 + persistance (" . spentTime($start, $end) . ")\n";