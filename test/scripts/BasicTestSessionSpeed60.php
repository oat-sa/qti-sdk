...
function loadTestDefinition(array &$average = null)
{
    ...
    $phpDoc->load(dirname(__FILE__) . '/../../test/samples/custom/php/linear_60_items.php');
...
function spentTime($start, $end, array &$registration = null)
{
    ...
    $endTime = explode(' ', $end);
    //var_dump('(' . $endTime[0] . '+' . $endTime[1] . ') - (' . $startTime[0] . '+' . $startTime[1] . ')');
...
echo "Retrieving session + attempt 41 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 42 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 43 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 44 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 45 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 46 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 47 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 48 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 49 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 50 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 51 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 52 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 53 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 54 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 55 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 56 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 57 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 58 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 59 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
...
echo "Retrieving session + attempt 60 + persistance (" . spentTime($start, $end, $averageAttempt) . ")\n";
