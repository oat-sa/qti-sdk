...
class JsonMarshallerTest extends QtiSmTestCase
{
    ...
    {
        $this->setExpectedException(MarshallingException::class, "The 'qtism\\runtime\\pci\\json\\Marshaller::marshall' method only takes State, QtiDatatype and null values as arguments", MarshallingException::NOT_SUPPORTED);
        $marshaller = new Marshaller();
