...
class AssociableHotspotTest extends QtiSmTestCase
{
    public function testCreateInvalidMatchMax()
    {
        ...
        new AssociableHotspot('identifier', true, QtiShape::RECT, new QtiCoords(QtiShape::RECT, array(0, 0, 1, 1)));
    }
    ...
    public function testCreateInvalidShape()
    {
        ...
        new AssociableHotspot('identifier', 1, true, new QtiCoords(QtiShape::RECT, array(0, 0, 1, 1)));
    }
    ...
    public function testSetInvalidMatchMin()
    {
        ...
        $associableHotspot = new AssociableHotspot('identifier', 1, QtiShape::RECT, new QtiCoords(QtiShape::RECT, array(0, 0, 1, 1)));
