...
class GapMarshallerTest extends QtiSmTestCase
{
    ...
    {
        $gap = new Gap('gap1');
        $gap->setMatchGroup(new IdentifierCollection(array('identifier1', 'identifier2')));
    ...
    public function testUnmarshall20()
    {
        ...
        $this->assertEquals(array('identifier1', 'identifier2'), $gap->getMatchGroup()->getArrayCopy());
    }
