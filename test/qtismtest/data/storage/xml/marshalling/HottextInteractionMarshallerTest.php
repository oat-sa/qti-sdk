...
class HottextInteractionMarshallerTest extends QtiSmTestCase {
	...
	public function testMarshall21() {
        ...
        $this->assertEquals('<hottextInteraction responseIdentifier="RESPONSE" maxChoices="2" minChoices="1"><prompt>Prompt...</prompt><div>This is a <hottext identifier="hot1"/> text... <hottext identifier="hot2"/></div></hottextInteraction>', $dom->saveXML($element));
	}
